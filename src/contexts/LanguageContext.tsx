...
const getTranslations = (language: Language): Record<string, string> => {
  const translations = {
    en: {
      ...
      'soil.blackSoil': 'Black Soil',
      'soil.redSoil': 'Red Soil',
      ...
      'soil.soybean': 'Soybean',
      'soil.vegetables': 'Vegetables',
      'soil.pulses': 'Pulses',
      'soil.locationPlaceholder': 'District, Tehsil, Village',
      ...
      'pest.clearPhoto': 'Take clear and sharp photo',
      'pest.closeup': 'Take close-up of affected leaf or crop',
      'pest.goodLight': 'Take photo in good lighting',
      'pest.aphid': 'Aphid',
      'pest.whitefly': 'Whitefly',
      'pest.podBorer': 'Pod Borer',
      'pest.leafSpot': 'Leaf Spot',
      'pest.neemOilSpray': 'Neem oil spray',
      'pest.yellowStickyTrap': 'Yellow sticky trap',
      'pest.btSpray': 'BT spray',
      'pest.copperSulfate': 'Copper sulfate',
    ...
    hi: {
      ...
      'soil.blackSoil': 'काली मिट्टी',
      'soil.redSoil': 'लाल मिट्टी',
      ...
      'soil.rice': 'धान',
      'soil.cotton': 'कपास',
      'soil.sugarcane': 'गन्ना',
      'soil.soybean': 'सोयाबीन',
      'soil.vegetables': 'सब्जी',
      'soil.pulses': 'दालें',
      'soil.locationPlaceholder': 'जिला, तहसील, गांव',
      ...
      'pest.clearPhoto': 'साफ और तेज तस्वीर लें',
      'pest.closeup': 'प्रभावित पत्ती या फसल का क्लोज-अप लें',
      'pest.goodLight': 'अच्छी रोशनी में फोटो लें',
      'pest.aphid': 'माहू',
      'pest.whitefly': 'सफेद मक्खी',
      'pest.podBorer': 'फली छेदक',
      'pest.leafSpot': 'पत्ती धब्बा',
      'pest.neemOilSpray': 'नीम तेल छिड़काव',
      'pest.yellowStickyTrap': 'पीला चिपचिपा ट्रैप',
      'pest.btSpray': 'बीटी स्प्रे',
      'pest.copperSulfate': 'कॉपर सल्फेट',
    ...
    pa: {
      ...
      'soil.blackSoil': 'ਕਾਲੀ ਮਿੱਟੀ',
      'soil.redSoil': 'ਲਾਲ ਮਿੱਟੀ',
      'soil.alluvial': 'ਜਲੋਢ਼ ਮਿੱਟੀ',
      'soil.sandy': 'ਰੇਤਲੀ ਮਿੱਟੀ',
      'soil.clay': 'ਚਿਕਨੀ ਮਿੱਟੀ',
      'soil.wheat': 'ਕਣਕ',
      'soil.rice': 'ਝੋਨਾ',
      'soil.cotton': 'ਕਪਾਹ',
      'soil.sugarcane': 'ਗੰਨਾ',
      'soil.soybean': 'ਸੋਯਾਬੀਨ',
      'soil.vegetables': 'ਸਬਜ਼ੀਆਂ',
      'soil.pulses': 'ਦਾਲਾਂ',
      'soil.locationPlaceholder': 'ਜ਼ਿਲ੍ਹਾ, ਤਹਿਸੀਲ, ਪਿੰਡ',
      ...
      'pest.clearPhoto': 'ਸਾਫ ਅਤੇ ਤਿੱਖੀ ਤਸਵੀਰ ਲਓ',
      'pest.closeup': 'ਪ੍ਰਭਾਵਿਤ ਪੱਤੇ ਜਾਂ ਫਸਲ ਦਾ ਕਲੋਜ਼-ਅੱਪ ਲਓ',
      'pest.goodLight': 'ਚੰਗੀ ਰੋਸ਼ਨੀ ਵਿੱਚ ਫੋਟੋ ਲਓ',
      'pest.aphid': 'ਮਾਹੂ',
      'pest.whitefly': 'ਚਿੱਟੀ ਮੱਖੀ',
      'pest.podBorer': 'ਫਲੀ ਛੇਦਕ',
      'pest.leafSpot': 'ਪੱਤੇ ਦਾ ਧੱਬਾ',
      'pest.neemOilSpray': 'ਨਿੰਮ ਤੇਲ ਸਪਰੇਅ',
      'pest.yellowStickyTrap': 'ਪੀਲਾ ਚਿਪਚਿਪਾ ਟ੍ਰੈਪ',
      'pest.btSpray': 'ਬੀਟੀ ਸਪਰੇਅ',
      'pest.copperSulfate': 'ਕਾਪਰ ਸਲਫੇਟ',
